      ...
      <SearchPanelWrap>
        ...
        <Flex>
          <SidebarWrap>
            ...
            <SidebarButton
              {...this.optionProps('onlyNamed')}
              title="Only show tracks with non-default names"
              icon={faFont}
            />
            <FlexGrow />
            <SidebarButton
              {...this.optionProps('lockQuery')}
              title="Lock search query"
              icon={faLock}
            />
          </SidebarWrap>
          <div style={{ position: 'relative' }}>
            <TrackSearchView
              onConfirmed={this.onConfirmedOrCancelled}
