...
const Num = ({ keyData, pressedKey }) => {
  ...
  return (
    <Number track={keyData.track} active={pressedKey === actualKey}>
      ...
      {track ? (
        <div>
          <TrackData>
            ...
            <div>
              <MuteSolo activeColor={`#D0C609`} active={track.solo}>
                S
              </MuteSolo>
              <MuteSolo activeColor={`#F97012`} active={track.mute}>
                M
              </MuteSolo>
        ...
        <div style={{ opacity: 0.2, fontSize: '.95em' }}>Track not found</div>
      )}
    </Number>
  )
}
